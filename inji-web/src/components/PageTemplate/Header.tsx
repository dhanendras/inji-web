    ...
    return (
        <header>
            <div
                ...
                className="fixed top-0 left-0 right-0 py-4 shadow-sm"
            ...
            >
                <div className="container mx-auto flex justify-between items-center px-4">
                    ...
                    <nav>
                        <ul className="flex space-x-4 items-center font-semibold">
                            <li data-testid="Header-Menu-AboutInji">
                                <a
                                    href="https://docs.mosip.io/inji/inji-web/overview"
                                    target="_blank"
                                    rel="noreferrer"
                                    className="text-#222222 hidden sm:inline-block"
                                >
                                    {t("Header.aboutInji")}
                                </a>
                            </li>
                            <li data-testid="Header-Menu-Help">
                                <div
                                    ...
                                    className="text-#222222 cursor-pointer hidden sm:inline-block"
                                >
                                    {t("Header.help")}
                                </div>
                            </li>
                            <li data-testid="Header-Menu-LanguageSelector" className="text-#222222">
                                <LanguageSelector />
                            </li>
                        </ul>
                    </nav>
                ...
                {isOpen && (
                    <div className="container mx-auto px-4 flex flex-col justify-start items-start font-semibold">
                        <div
                            data-testid="Header-Menu-AboutInji"
                        ...
                        >
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="text-iw-title inline-block sm:hidden"
                            >
                                {t("Header.aboutInji")}
                            </a>
                        </div>
